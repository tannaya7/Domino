// Hand-curated knowledge base mapping package names / env-var keys to the third-party vendor
// they belong to. This is intentionally curated, not dynamically discovered — accuracy here is
// the whole point. `substrate` is a coarse hosting-provider tag (not a specific region), because
// exact regions aren't reliably publishable/verifiable for most vendors; SLA and substrate are
// both editable per-node once surfaced in the UI, not treated as ground truth.

import type { VendorEntry } from '../../src/lib/types'

export type { VendorEntry, VendorTier } from '../../src/lib/types'

/** Keyed by the npm/pip/go/gem/maven package (or artifact) name most commonly imported. */
...
/** Maps common environment-variable names to the VENDOR_MAP key they imply. */
